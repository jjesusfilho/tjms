#' Ler metadados das decisões do TJMS
#'
#' @param arquivos Vetor de arquvos a serem lidos
#' @param diretorio Diretório onde se encontram os htmls, caso não informe os arquivos
#'
