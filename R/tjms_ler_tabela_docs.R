#' Ler tabelas baixadas com tjms_baixar_tabela_docs
#'
...
#' @export
#'
tjms_ler_tabela_docs <- function(arquivos = NULL, diretorio = "."){
    ...
    suppressMessages({
      df <-   .x %>%
        ...
        dplyr::mutate(pagina_inicial = stringr::str_extract(paginas,"\\d+"),
                      ...
                      processo = processo,
                      url_doc = paste0("https://esaj.tjms.jus.br/pastadigital/getPDF.do?",url_doc)) %>%
